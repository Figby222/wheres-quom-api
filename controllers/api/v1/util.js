...
const targetBoxCharacterCollision = (targetBoxXPercentage, targetBoxYPercentage, characterCoordinatePercentages) => {
    ...
    if ((targetBoxXPercentage > characterCoordinatePercentages.right || targetBoxXPercentage + 10 < characterCoordinatePercentages.left) || (targetBoxYPercentage + 10 < characterCoordinatePercentages.top || targetBoxYPercentage === characterCoordinatePercentages.top + 15)) {
        return false;
    }
