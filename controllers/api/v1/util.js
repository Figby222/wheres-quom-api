...
const targetBoxCharacterCollision = (targetBoxXPercentage, targetBoxYPercentage, characterCoordinatePercentages) => {
    if ((targetBoxXPercentage > characterCoordinatePercentages.left || targetBoxXPercentage + 10 < characterCoordinatePercentages.left) && targetBoxXPercentage != characterCoordinatePercentages.left + 1) {
        return false;
    }
